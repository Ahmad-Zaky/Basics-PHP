            ...
            <div class="shadow sm:overflow-hidden sm:rounded-md">
                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <textarea id="body" name="body" maxlength="500" minlength="50" rows="3" class="mt-1 block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6" placeholder="Here's an idea for a note ..."><?= old("body", "") ?></textarea>
